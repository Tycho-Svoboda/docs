---
title: 'Quickstart'
description: 'Get started with TensorPool in 30 seconds.'
icon: 'rocket'
---

## Get started with TensorPool in 3 easy steps.
{/*
1) Run **pip install tensorpool** in terminal

*/}
1) Add **import tensorpool** to the top of your file
2) Wrap your model using the command **with TensorPool:**
3) Once you have your model, simply add **.realize()** to the end to train on TensorPool

And thats how easy it is to use TensorPool!

## Walkthrough Video
<iframe
  width="670"
  height="400"
  src="https://www.youtube.com/embed/nrLfbC40OCA"
